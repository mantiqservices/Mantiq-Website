      ...
      <footer className="py-12 sm:py-16 px-6 sm:px-10 border-t border-slate-100 reveal">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 sm:gap-8">
            <a href= target="_blank" rel="noopener" className="text-sky-500 hover:text-sky-600 font-bold text-[10px] uppercase tracking-widest transition-colors flex items-center gap-1.5"><Calculator size={11}/> {t.pricing}</a>
